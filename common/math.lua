...
function GLOBAL[category].rgb2hsv(r,g,b)
...
function GLOBAL[category].hsv2rgb(h,s,v)
  local r, g, b
...
function GLOBAL[category].rgb2hex(r,g,b,a)
  if a then
...
function GLOBAL[category].hex2rgb(hex)
  local hex = hex:gsub("#","")
  return tonumber("0x"..hex:sub(1,2)),tonumber("0x"..hex:sub(3,4)),tonumber("0x"..hex:sub(5,6))
end

-- Does math.ceil or math.floor depending on the number
function GLOBAL[category].round(number)
  return math.ceil(number-0.5)
end

-- Gets percent of a number
function GLOBAL[category].percent(number,maxvalue)
  return number/maxvalue
end

-- Returns 2 values representing a part of their sum
function GLOBAL[category].relate(number,number2)
